...
| bootstrap、首次安装与分发 | #55 | `bootstrap.py`、`cli.py`、wheel/sdist | `test_issue_55_bootstrap_cli.py`、`smoke_distribution.py` |
| 跨层用户行为 | #56 | 上述同版合同 | `test_issue_49_reconstruction.py`（含 App→CLI operate、App↔CLI cancel） |
